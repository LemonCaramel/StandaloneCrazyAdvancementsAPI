...
public final class AdvancementManager {
    ...
    public void update(Player player) {
        if (players.contains(player)) {
            ...
            addPlayer(player);
            Bukkit.getScheduler().runTaskLater(CrazyAdvancements.plugin, () -> CrazyAdvancements.setActiveTab(player, rootAdvancement), 5);
        }
    }
    ...
    private String getSaveDirectory(String namespace) {
        return CrazyAdvancements.plugin.getDataFolder().getAbsolutePath() + File.separator + "saved_data" + File.separator + namespace + File.separator;
    }
